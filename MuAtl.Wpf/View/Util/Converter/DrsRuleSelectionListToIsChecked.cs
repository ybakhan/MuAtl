...
{
  public class DrsRuleSelectionListToIsChecked : IMultiValueConverter
  {
    public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
    {
      var selectedRules = (values[0] as IEnumerable<DrsCandidate>);
      var allRules = values[1] as SelectionList<DrsCandidate>;
